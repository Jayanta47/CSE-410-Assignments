...
void Transformation::generateViewMatrix(Point eye, Point look, Point up) {
    ...
    translationTransformation.printMatrix();
    printMatrix();
...
int main(int argc, char** argv) {
    ...
    while(true) {
        ...
        if(command.compare("triangle") == 0) {
            ...
            triangleCounter++;
            //cout<<"triangle : "<<triangleCounter<<endl;
            //p1.printpoint();
            //p2.printpoint();
            //p3.printpoint();
            ...
            //transformationMatrixStack.top().printMatrix();
    ...
    viewTransformation.printMatrix();
    ...
    fstream leftfile;
    leftfile.open("leftfile.txt",ios::out);
    ...
    */
    ...
    for(int i=0, topScanline, bottomScanline; i<triangleCounter; i++) {
        ...
        //cout<<"max : "<<maxY<<endl<<"min : "<<minY<<endl;
        if(maxY >= topY) {
            topScanline = 0;
        } else {
            //cout<<"top : "<<topY<<endl<<"max "<<maxY<<endl<<"dy: "<<dy<<endl;
        ...
        // cout<<"top : "<<topScanline<<endl<<"bottom : "<<bottomScanline<<endl;
        for(int row=topScanline, leftIntersectingColumn, rightIntersectingColumn; row<=bottomScanline; row++) {
            ...
            for(int j=0; j<3; j++) {
                ...
                if(intersectingPoints[j].getX() != INF) {
                    if(intersectingPoints[j].getX()>max(p1.getX(), p2.getX()) || intersectingPoints[j].getX()<min(p1.getX(), p2.getX()) 
                    // || intersectingPoints[j].getY()>max(p1.getY(), p2.getY()) || intersectingPoints[j].getY()<min(p1.getY(), p2.getY())
                    ) {
            ...
            // cout<<maxX<<" "<<minX<<endl;
            // cout<<intersectingPoints[maxIndex].getX()<<" "<<intersectingPoints[minIndex].getX()<<endl;
            ...
            // cout<<leftIntersectingColumn<<endl;
            ...
            //cout<<"left : "<<leftIntersectingColumn<<endl<<"right : "<<rightIntersectingColumn<<endl;
            //leftfile<<"left : "<<leftIntersectingColumn<<endl<<"right : "<<rightIntersectingColumn<<endl;
    ...
    for(int row=0; row<screenHeight; row++) {
        for(int column=0; column<screenWidth; column++) {
            if(zBuffer[row][column] < rearLimitZ) {
                output <<fixed<< zBuffer[row][column] << '\t';
            }
        }
        output << endl;
    }
