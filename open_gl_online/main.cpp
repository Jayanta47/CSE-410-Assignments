...
//    sq_side ++;
//    radius_curv++;
//    if (radius_curv>0.0) radius_curv ++;

    sq_side = min(maxThresh, sq_side + sphr2cubeRate);
    radius_curv = min(maxThresh, radius_curv + sphr2cubeRate);
}

void decrease_size()
{
    if (maxThresh>=1) maxThresh--;
//    if (sq_side>=1) sq_side --;
//    if (radius_curv>=1)radius_curv --;
